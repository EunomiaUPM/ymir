...
use crate::data::entities::req_vc::{Entity, NewModel};
use crate::services::repo::subtraits::{BasicRepoTrait, ReqVcTrait};
...
impl BasicRepoTrait<Entity, NewModel> for ReqVcRepo {
